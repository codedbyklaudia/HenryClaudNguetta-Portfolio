      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; background: #ffffff; color: #1a1a1a; border-radius: 8px; overflow: hidden; border: 1px solid #e0d9d0;">
          <div style="background: #f2ede6; padding: 40px; border-bottom: 1px solid #e0d9d0;">
            <h1 style="margin: 0; font-size: 22px; font-weight: normal; letter-spacing: 0.05em; color: #1a1a1a;">
              New Contact Message
            </h1>
            <p style="margin: 8px 0 0; color: #888; font-size: 13px; font-family: sans-serif;">
            ...
            <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 14px;">
              ...
              <tr>
                ...
                <td style="padding: 10px 0;">
                  <a href="mailto:${email}" style="color: #ABA021; text-decoration: none;">${email}</a>
                </td>
              </tr>
            </table>
